...
<br/>
<form>
<label for="buscaTipoRACAP">Buscar Tipo de RACAP: </label>
<select>
<option id="buscaTipoRACAP">Selecione o tipo de RACAP a Buscar...</option>
</select>
</form>
<hr>
<form method="POST" id="cadTipoUsuario" action="usuario_manage.php">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<label for="nomeTipoUsuario">Tipo de RACAP: </label>
