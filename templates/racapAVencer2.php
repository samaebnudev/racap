...
$dateBuffer = $_POST['dataHoje'];
$dataIni = date('Y-m-d 00:00:00', strtotime($dateBuffer));

$dateBuffer2 = $_POST['dataLimite'];
...
AND (racap_status_racap.id = '1' OR racap_status_racap.id = '3')
...
if (mysqli_affected_rows($conexao) > 0) {
    ...
    $tabelaRACAPS = "<tr>"
            ...
            ."<h2>Não há RACAP's no Sistema vencendo até a data pesquisada.</h2>"
            . "</td>"
            . "</tr>";
}
?>
