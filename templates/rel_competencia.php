...
//Define o cabe�alho com título e data inclusos.
$pageHeader = "<page>
<page_header>
<div id='logo'><img src='img/logo_samae.png' /></div>
<div id='samaeHeader'>
<p><h4>SAMAE - Serviço Autônomo Municipal de �gua e Esgoto</h4>
...
if (mysqli_affected_rows($conexao) > 0){
		...
		echo "<table>
		<tr>
		<th>Usu�rio</th><th>Tipo de Glosa</th><th>Data Inicial</th><th>Data Final</th><th>Dura��o</th><th>Qtd. Ocorr�ncias</th><th>Ticket</th><th>Procede (S/N)</th>
		</tr>";
		...
		echo "<tr>
		<td>".$row['nomeUsuario']."</td><td>".$descRes."</td><td>".$dataInicio."</td><td>".$dataFim."</td><td>".$row['duracao']."</td>
...
elseif (mysqli_affected_rows($conexao) == 0){
	echo "<p><h4>N�o h� Glosas cadastradas na compet�ncia atual.</h4></p>";
}	
//Fim do relat�rio.
echo $pageFooter;	
?>