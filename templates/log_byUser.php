...
visto que em glosa_log não há uma chave estrangeira para o id do usuario*/
...
if (isset ($_GET['dataIni'])){
	...
	$tableQueryFail = "<p><h4>Não existe(m) atividade(s) do(a) usuário(a) no período pesquisado.</h4></p>";
...
elseif (isset ($_GET['entries'])){
	...
	//Se a query da tabela falhar será exibida uma mensagem
	$tableQueryFail = "<p><h4>Não existe(m) atividade(s) do(a) usuário(a) no Sistema.</h4></p>";
