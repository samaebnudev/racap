...
$byDateDataInicio = date('Y-m-d 00:00:00', strtotime($_POST['byDateDataInicio']));
$byDateDataFim = date('Y-m-d 23:59:59', strtotime($_POST['byDateDataFim']));

$dataIni = date('d/m/Y', strtotime($_POST['byDateDataInicio']));
$dataFim = date('d/m/Y', strtotime($_POST['byDateDataFim']));
