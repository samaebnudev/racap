...
if (isset($_SESSION['id'])) {
    if ($_SESSION['tipoPrivilegio'] != '1') {
        ...
        $ocorrencia = "Tentativa de acesso sem privilégio administrativo em motivo_abertura_racap.php";
...
<html >
    <head>
        <meta charset="UTF-8">
        <title>Controle de RACAP's - Motivos de Abertura</title>
        ...
        <script src="js/buscaMotivoAberturaRacap.js"></script>
    </head>

    <body>
        <div class="topbar">
            <h2 align="center">Controle de RACAP - Motivos de Abertura</h2>
            <div  class="open">
                <span class="cls"></span>
                <span>
                    <ul class="sub-menu ">
        ...
        <form method="POST" id="cadMotivoAberturaRacap" action="motivo_abertura_racap_manage.php">
            ...
            <p align="center">
                <input type="submit" class="btn" value="Gravar" title="Incluir ou Salvar Motivo da Abertura"/>
                &nbsp;&nbsp;
